...
const AboutPage: React.FC<PageProps> = () => (
  <article>
    ...
    <div className="container rich-text">
      ...
      <p>
        <strong>
          We are committed to helping each of our clients succeed. For this
          reason, our employees are always up-to-date with the latest audit,
          accounting, and tax requirements. It ensures that we deliver
          accurately the best advice combined with solid and dependable customer
          service.
        </strong>
      </p>
      <p>
