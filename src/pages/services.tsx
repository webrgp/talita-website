    ...
    <div className="container">
      <div className="row align-items-start align-items-lg-center my-5">
        ...
        <div className="col-12 col-sm-7 col-md-9">
          <h3 className="mt-4 mt-sm-0">Translations</h3>
          <p>
      ...
      <div className="row align-items-start align-items-lg-center my-5">
        ...
        <div className="col-12 col-sm-7 col-md-9">
          <h3 className="mt-4 mt-sm-0">Taxes &amp; Tax Resolutions</h3>
          <p>
            ...
            at Talita Camilo Professional Services to work with the IRS for you.
          </p>
        </div>
      </div>
      ...
      <div className="row align-items-start align-items-lg-center my-5">
        ...
        <div className="col-12 col-sm-7 col-md-9">
          <h3 className="mt-4 mt-sm-0">Bookkeeping & Payroll</h3>
          <p>
      ...
      <div className="row align-items-start align-items-lg-center my-5">
        ...
        <div className="col-12 col-sm-7 col-md-9">
          <h3 className="mt-4 mt-sm-0">Consulting</h3>
          <p>
